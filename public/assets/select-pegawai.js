       ...
       console.log('id_kehadiran '+id_kehadiran);
           ...
           $.ajax({
               ...
               success: function(data){
                  ...
                  document.getElementById('gaji_pokok').value=data[2][0].NOMINAL_GAJI_UTAMA;
                  document.getElementById('tunjangan').value=data[3][0].tunjangan;
                  document.getElementById('potongan_tunjangan').value=data[0].POTONGAN_TUNJANGAN*100+" %";

                  $tunjangan        = data[3][0].tunjangan;
                  ...
                  $gaji_utama = data[2][0].NOMINAL_GAJI_UTAMA;
