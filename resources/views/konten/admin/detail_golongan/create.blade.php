                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                          Form <span class="fa-angle-right fa"></span> Data Detail Golongan
                        </p>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="panel-heading">
                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            ...
                            <form class="form-horizontal form-material" action="storedetailgolongan" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="name" placeholder="Please input nama detail golongan"
                                                ...
                                                id="NAMA_DETAIL_GOLONGAN" required>
                                        </div>
                                    </div>                                    
                                    <div class="form-group">
