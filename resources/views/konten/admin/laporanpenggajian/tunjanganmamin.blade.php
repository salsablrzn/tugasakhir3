...
<div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Tunjangan Makan Minum</h3>
                        <p class="animated fadeInDown">
                          Table <span class="fa-angle-right fa"></span> Tunjangan Makan Minum
                        </p>
                    </div>
                  </div>
              </div>
...
<!--                         <a href="admincreatedataakun" class="btn btn-success d-none d-md-inline-block text-white" target="_blank">Add TU</a> -->
                      ...
                      <thead>
                                             <tr>
                                                ...
                                                <th class="border-top-0">Jumlah Tunjangan Mamin</th>
