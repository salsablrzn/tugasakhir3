                          ...
                          <div class="col-md-12">
                            ...
                            <form class="form-horizontal form-material" action="storenilai" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="gaji_pokok" class="form-control pl-0 form-control-line" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-nama" class="col-md-12">Tunjangan</label>
                                        <div class="col-md-12">
                                            <input type="text" id="tunjangan" class="form-control pl-0 form-control-line" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-nama" class="col-md-12">Potongan Tunjangan</label>
                                        <div class="col-md-12">
                                            <input type="text" id="potongan_tunjangan" class="form-control pl-0 form-control-line" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-nama" class="col-md-12">Total Tunjangan</label>
                                        <div class="col-md-12">
                                            <input type="text" id="total_tunjangan" class="form-control pl-0 form-control-line" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-nama" class="col-md-12">Total Gaji</label>
                                        <div class="col-md-12">
                                            <input type="text" id="total_gaji" class="form-control pl-0 form-control-line" >
                                        </div>
                                    </div>
